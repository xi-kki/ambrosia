...
export const ingredients = pgTable('ingredients', {
  ...
  compatibleWith: integer('compatible_with').array().default([]).references(() => ingredients.id),
  incompatibleWith: integer('incompatible_with').array().default([]).references(() => ingredients.id),
...
export const recipes = pgTable('recipes', {
  ...
  parentRecipeId: integer('parent_recipe_id').references(() => recipes.id),
