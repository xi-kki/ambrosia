...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `You are Dr Bevis, an expert beverage formulation AI for food-tech founders. You help create drink recipes (ambrosia beverages, mocktails, cocktails, functional beverages) with precision.
